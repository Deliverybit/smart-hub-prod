...
# All dark tip popups on phone/tablet — beats generic layout `border: 1px solid #555`.
_DARK_MOBILE_TABLET_ALL_TIP_BORDER_RULES = f"""
html[data-scoop-theme="dark"] {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="dark"] {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-label .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="dark"] {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-val .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="dark"] {_DARK_RESPONSIVE_TIP_SCOPE} [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="dark"] {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap.headlines-tip .tip-text {{
    border: 2px solid #ffffff !important;
}}
"""
# Light tip popups on phone/tablet — green outline matching screener card accent.
_LIGHT_MOBILE_TABLET_ALL_TIP_BORDER_RULES = f"""
html:not([data-scoop-theme="dark"]) {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap:not(.headlines-tip) .tip-text,
html:not([data-scoop-theme="dark"]) {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-label .tip-wrap:not(.headlines-tip) .tip-text,
html:not([data-scoop-theme="dark"]) {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-val .tip-wrap:not(.headlines-tip) .tip-text,
html:not([data-scoop-theme="dark"]) {_DARK_RESPONSIVE_TIP_SCOPE} [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip) .tip-text,
html:not([data-scoop-theme="dark"]) {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap.headlines-tip .tip-text,
html[data-scoop-theme="light"] {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="light"] {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-label .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="light"] {_DARK_RESPONSIVE_TIP_SCOPE} .full-results-wrap .full-results-table tbody td .fr-val .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="light"] {_DARK_RESPONSIVE_TIP_SCOPE} [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip) .tip-text,
html[data-scoop-theme="light"] {_DARK_RESPONSIVE_TIP_SCOPE} .tip-wrap.headlines-tip .tip-text {{
    border: 2px solid #22c55e !important;
}}
"""
_MOBILE_TABLET_TIP_THEME_BORDER_RULES = (
    _DARK_MOBILE_TABLET_ALL_TIP_BORDER_RULES + _LIGHT_MOBILE_TABLET_ALL_TIP_BORDER_RULES
)
# Mobile/tablet: company/name/commodity values get the same dashed tip underline as
# column labels. inline-block keeps the underline under the text (not full cell width).
# Always expand via _name_value_tip_selectors — _NAME_VALUE_TIP_SELECTOR is comma-joined
# and would drop the theme/scope prefix on Name/Commodity if interpolated directly.
_MOBILE_TABLET_NAME_VALUE_TIP_UNDERLINE_RULES = f"""
{_name_value_tip_selectors(_DARK_RESPONSIVE_TIP_SCOPE)} {{
    display: inline-block !important;
    max-width: 100% !important;
    width: auto !important;
    white-space: normal !important;
...
{_name_value_tip_selectors('html[data-scoop-theme="dark"] ' + _DARK_RESPONSIVE_TIP_SCOPE)} {{
    border-bottom: 2px dashed #ffffff !important;
}}
"""
...
{_name_value_tip_selectors('html[data-scoop-theme="dark"] ' + _DARK_RESPONSIVE_TIP_SCOPE, " .tip-text")} {{
    background: #0f172a !important;
    background-color: #0f172a !important;
    color: #e5e7eb !important;
    border: 2px solid #ffffff !important;
}}
{_name_value_tip_selectors('html[data-scoop-theme="dark"] ' + _DARK_RESPONSIVE_TIP_SCOPE, " .tip-text::after")} {{
...
# Harmless full-width app container only — no overlay sidebar / Streamlit arrows.
TABLET_SIDEBAR = """
        :root {
...
# Desktop Analyze only: page depth, tighter type, card surfaces. Phone/tablet unchanged.
_DESKTOP_ANALYZE_POP_RULES = """
    html[data-scoop-analyze-active="1"] body,
    html[data-scoop-analyze-active="1"] .stApp,
    html[data-scoop-analyze-active="1"] [data-testid="stAppViewContainer"],
    html[data-scoop-analyze-active="1"] [data-testid="stMainBlockContainer"] {
        background:
            radial-gradient(ellipse 80% 36% at 12% -8%, rgba(14, 165, 233, 0.14), transparent 58%),
            radial-gradient(ellipse 50% 28% at 92% 0%, rgba(37, 99, 235, 0.08), transparent 52%),
            linear-gradient(180deg, #f8fbff 0%, #f1f5f9 48%, #eef2f7 100%) !important;
    }
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] body,
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] .stApp,
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] [data-testid="stAppViewContainer"],
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] [data-testid="stMainBlockContainer"] {
        background:
            radial-gradient(ellipse 80% 36% at 12% -8%, rgba(56, 189, 248, 0.16), transparent 58%),
            radial-gradient(ellipse 50% 28% at 92% 0%, rgba(37, 99, 235, 0.12), transparent 52%),
    ...
    html[data-scoop-analyze-active="1"] [data-testid="stDecoration"] {
        height: 0 !important;
        min-height: 0 !important;
        max-height: 0 !important;
        overflow: hidden !important;
    ...
    html[data-scoop-analyze-active="1"] a.scoop-analyze-back:hover {
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] [data-testid="stMainBlockContainer"] h1 {
        text-decoration-color: #38bdf8 !important;
    }
    html[data-scoop-analyze-active="1"] .scoop-selected-asset-card {
        background: #ffffff !important;
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] .scoop-selected-asset-card {
    ...
    html[data-scoop-analyze-active="1"] .scoop-analyze-direction-banner {
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] [data-testid="stMetric"] {
        background: linear-gradient(180deg, #1e293b 0%, #0f172a 100%) !important;
        border-color: rgba(56, 189, 248, 0.28) !important;
    }
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] .mood-feed {
        background: #0f172a !important;
        border-color: rgba(56, 189, 248, 0.22) !important;
    }
    html[data-scoop-analyze-active="1"] .mood-feed table {
    ...
    html[data-scoop-analyze-active="1"] .mood-feed thead th:first-child {
        border-radius: 10px 0 0 0 !important;
    }
    html[data-scoop-analyze-active="1"] .mood-feed thead th:last-child {
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] .mood-feed tbody td {
        border-bottom-color: #1e293b !important;
    }
    html[data-scoop-analyze-active="1"] .mood-feed tbody tr:hover td {
        background: #f0f9ff !important;
    }
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] .mood-feed tbody tr:hover td {
        background: rgba(14, 165, 233, 0.12) !important;
    }
    html[data-scoop-analyze-active="1"] .mood-feed a {
    ...
    html[data-scoop-theme="dark"][data-scoop-analyze-active="1"] [data-testid="stPlotlyChart"] {
        background: #0f172a !important;
        border-color: rgba(56, 189, 248, 0.22) !important;
    }
...
_desktop_analyze_pop_attr = _DESKTOP_ANALYZE_POP_RULES.replace(
    'html[data-scoop-theme="dark"][data-scoop-analyze-active="1"]',
    'html[data-scoop-theme="dark"][data-scoop-desktop-layout="1"][data-scoop-analyze-active="1"]',
).replace(
    'html[data-scoop-analyze-active="1"]',
    'html[data-scoop-desktop-layout="1"][data-scoop-analyze-active="1"]',
)
...
def _desktop_screener_top_compact_for(flag_attr: str) -> str:
    ...
    {root} [data-testid="stToolbar"],
    {root} [data-testid="stDecoration"] {{
        height: 0 !important;
        min-height: 0 !important;
        max-height: 0 !important;
        overflow: hidden !important;
    ...
    {root} [data-testid="stMainBlockContainer"] [data-testid="stElementContainer"]:has(.disclaimer-footer),
    {root} [data-testid="stMainBlockContainer"] [data-testid="element-container"]:has(.disclaimer-footer) {{
        margin-bottom: 0 !important;
        padding-bottom: 0 !important;
    }}
"""
...
@media (min-width: 1367px) {{
    ...
    html:not([data-scoop-home-page="1"]) [data-testid="stToolbar"],
    html:not([data-scoop-home-page="1"]) [data-testid="stDecoration"] {{
        height: 0 !important;
        min-height: 0 !important;
        max-height: 0 !important;
        overflow: hidden !important;
...
@media (min-width: 1367px) {
    ...
    html[data-scoop-theme="dark"]:not([data-scoop-home-page="1"]) .disclaimer-footer a {
        color: #93c5fd !important;
        text-decoration: underline !important;
        text-underline-offset: 0.14em !important;
    }
...
_DESKTOP_SCREENER_GATING_LAYOUT_RULES = """
    ...
    html[data-scoop-screener-gated="1"] .stApp,
    html[data-scoop-screener-gated="1"] [data-testid="stAppViewContainer"],
    html[data-scoop-screener-gated="1"] [data-testid="stMain"],
    html[data-scoop-screener-gated="1"] [data-testid="stAppScrollToBottomContainer"] {
        height: 100dvh !important;
        max-height: 100dvh !important;
        overflow: hidden !important;
        scrollbar-width: none !important;
    }
    html[data-scoop-screener-gated="1"]::-webkit-scrollbar,
    html[data-scoop-screener-gated="1"] body::-webkit-scrollbar,
    html[data-scoop-screener-gated="1"] .stApp::-webkit-scrollbar,
    html[data-scoop-screener-gated="1"] [data-testid="stAppViewContainer"]::-webkit-scrollbar,
    html[data-scoop-screener-gated="1"] [data-testid="stMain"]::-webkit-scrollbar,
    html[data-scoop-screener-gated="1"] [data-testid="stAppScrollToBottomContainer"]::-webkit-scrollbar {
        width: 0 !important;
        height: 0 !important;
        display: none !important;
    }
    ...
    html[data-scoop-screener-gated="1"] .disclaimer-footer {
        position: fixed !important;
        bottom: 0 !important;
        left: var(--footer-sidebar-width, clamp(12rem, 20vw, 36rem)) !important;
        width: calc(100% - var(--footer-sidebar-width, clamp(12rem, 20vw, 36rem))) !important;
    ...
    html[data-scoop-screener-gated="1"] [data-testid="stElementContainer"]:has(.disclaimer-footer),
    html[data-scoop-screener-gated="1"] [data-testid="element-container"]:has(.disclaimer-footer) {
        overflow: visible !important;
...
@media (max-width: 768px) {{
    ...
    {_GATED_MOBILE_TAB_MAIN} [data-testid="stVerticalBlock"] {{
    ...
    {_GATED_MOBILE_TAB_MAIN} h1 {{
        margin-top: 0.04rem !important;
        margin-bottom: 0.1rem !important;
    }}
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_DARK_MODE_ROW} {{
        margin-bottom: 0 !important;
        padding-bottom: 0 !important;
        min-height: 0 !important;
    }}
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_DARK_MODE_ROW} div[data-testid="stToggle"],
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_DARK_MODE_ROW} div[data-testid="stCheckbox"] {{
        margin-bottom: 0 !important;
        margin-top: 0 !important;
    }}
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_SCREENER_INDEX_BANNER_CONTAINER},
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_DARK_MODE_ROW} + [data-testid="stElementContainer"],
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_DARK_MODE_ROW} + [data-testid="element-container"] {{
        margin-top: 0 !important;
        margin-bottom: 0 !important;
        padding: 0 !important;
    }}
    ...
    {_GATED_MOBILE_TAB_MAIN} [data-testid="stElementContainer"]:has([data-testid="stCheckbox"]):not(:has(.scoop-mobile-inner-top-toggle)) div[data-testid="stCheckbox"],
    {_GATED_MOBILE_TAB_MAIN} [data-testid="element-container"]:has([data-testid="stCheckbox"]):not(:has(.scoop-mobile-inner-top-toggle)) div[data-testid="stCheckbox"],
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_TERMS_CHECKBOX_ROW},
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_TERMS_CHECKBOX_ROW} div[data-testid="stCheckbox"] {{
        margin-top: 0.1rem !important;
        margin-bottom: 0.08rem !important;
        padding-bottom: 0 !important;
        padding-top: 0.28rem !important;
    }}
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_TERMS_CHECKBOX_ROW} + [data-testid="stElementContainer"],
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_TAB_TERMS_CHECKBOX_ROW} + [data-testid="element-container"],
    {_GATED_MOBILE_TAB_MAIN} [data-testid="stElementContainer"]:has(.disclaimer-footer),
    {_GATED_MOBILE_TAB_MAIN} [data-testid="element-container"]:has(.disclaimer-footer) {{
        margin: 0 !important;
        padding: 0 !important;
    }}
    ...
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] .scoop-banner-desktop,
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] .scoop-banner-compact,
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] {_MOBILE_SCREENER_INDEX_BANNER_CONTAINER} {{
        display: none !important;
        height: 0 !important;
        min-height: 0 !important;
    ...
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] [data-testid="stElementContainer"]:has(iframe),
    html[data-scoop-screener-gated="1"][data-scoop-tab-nav="1"] [data-testid="element-container"]:has(iframe) {{
        display: none !important;
        height: 0 !important;
        min-height: 0 !important;
        margin: 0 !important;
...
""" + _MOBILE_TABLET_BANNER_COMPACT_ONLY + _MOBILE_INDEX_BANNER_FULL_WIDTH + _MOBILE_TABLET_INDEX_BANNER_TYPE + _MARKET_MOBILE_TABLET_TOGGLE_BOXED + _MOBILE_TABLET_TERMS_CHECKBOX_RESTORE + _MOBILE_TABLET_DARK_MODE_PILL_LAYOUT_FINAL + _MOBILE_TABLET_CONSENT_DISCLAIMER_GAP_FINAL + _MOBILE_TABLET_DARK_MODE_UNBOX_ALWAYS + _PHONE_GATED_SCREENER_FIT
...
RESPONSIVE_SIDEBAR_BOOTSTRAP = TABLET_SIDEBAR_TOGGLE_AVAILABILITY

TABLET_SCREENER_INNER = TABLET_SCREENER_MOBILE_LAYOUT

TABLET_SEARCH_INNER = TABLET_SEARCH_MOBILE_LAYOUT

TABLET_TERMS_INNER = TABLET_TERMS_MOBILE_LAYOUT
...
_ZENBOOK_IPAD_MINI_SCREENER_INNER = TABLET_SCREENER_MOBILE_LAYOUT

_ZENBOOK_IPAD_MINI_SEARCH_INNER = TABLET_SEARCH_MOBILE_LAYOUT

_ZENBOOK_IPAD_MINI_TERMS_INNER = TABLET_TERMS_MOBILE_LAYOUT
...
html body .stApp .disclaimer-footer a,
html body .stApp .disclaimer-footer a:link,
html body .stApp .disclaimer-footer a:visited,
html body .stApp .disclaimer-footer a:hover,
html body .stApp .disclaimer-footer a:active,
html:not([data-scoop-theme="dark"]) body .stApp .disclaimer-footer a,
html:not([data-scoop-theme="dark"]) body .stApp .disclaimer-footer a:link,
html:not([data-scoop-theme="dark"]) body .stApp .disclaimer-footer a:visited,
html:not([data-scoop-theme="dark"]) body .stApp .disclaimer-footer a:hover,
html:not([data-scoop-theme="dark"]) body .stApp .disclaimer-footer a:active,
html[data-scoop-theme="dark"] body .stApp .disclaimer-footer a,
html[data-scoop-theme="dark"] body .stApp .disclaimer-footer a:link,
html[data-scoop-theme="dark"] body .stApp .disclaimer-footer a:visited,
html[data-scoop-theme="dark"] body .stApp .disclaimer-footer a:hover,
html[data-scoop-theme="dark"] body .stApp .disclaimer-footer a:active {
    color: #93c5fd !important;
    text-decoration: underline !important;
    text-underline-offset: 0.14em !important;
...
# Phone/tablet Cloud: collapse the huge Streamlit divider gap under results.
_MOBILE_TABLET_RESULTS_DIVIDER_GAP_CSS = """
@media (max-width: 1366px) {
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) .full-results-wrap {
        margin-bottom: 0.2rem !important;
        padding-bottom: 0 !important;
    }
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="stElementContainer"]:has(.full-results-wrap) ~ [data-testid="stElementContainer"]:has(hr),
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="element-container"]:has(.full-results-wrap) ~ [data-testid="element-container"]:has(hr),
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="stElementContainer"]:has(.full-results-wrap) ~ [data-testid="stElementContainer"]:has([data-testid="stDivider"]),
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="element-container"]:has(.full-results-wrap) ~ [data-testid="element-container"]:has([data-testid="stDivider"]) {
        height: 0 !important;
        min-height: 0 !important;
        max-height: 0 !important;
        margin: 0 !important;
    ...
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="stDivider"],
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] hr,
    html[data-scoop-tab-nav="1"]:not([data-scoop-home-page="1"]) [data-testid="stMainBlockContainer"] [data-testid="stMarkdownContainer"] hr {
        display: none !important;
        height: 0 !important;
        min-height: 0 !important;
        margin: 0 !important;
