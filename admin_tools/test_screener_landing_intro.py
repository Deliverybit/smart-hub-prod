...
def test_gated_mobile_refine_css_restores_readable_spacing() -> None:
    ...
    assert "clamp(1.85rem, 3.6vw, 2.15rem)" in _GATED_NAMED_TABLET_MARKET_TYPE_CSS
    assert "font-size: 2.05rem !important;" in _GATED_NAMED_TABLET_MARKET_TYPE_CSS
    ...
    assert "min-width: 1367px) and (max-width: 1420px)" in _GATED_IPAD13_SURFACE_DESKTOP_TYPE_CSS
    assert "font-size: 5rem !important;" in _GATED_IPAD13_SURFACE_DESKTOP_TYPE_CSS
    assert _GATED_IPAD13_SURFACE_DESKTOP_TYPE_CSS in DESKTOP_SCREENER_GATING_LAYOUT
