"""
CME Commodities
Screens major CME Group-traded commodity futures for those trading at or
near their 52-week low **and** whose recent headlines do NOT contain
signals of severe disruption or regulatory bans.
"""
...
render_responsive_navigation(current_page="pages/5_CME_Top_10.py")
...
agreed = terms_accepted(st, "agree_terms_cme")
...
COMMODITY_NAMES = {
    ...
    # Dairy (CME)
    "DC=F":  "Class III Milk",
    # Indices-related (CME) – included as tradeable commodities
    "ES=F":  "E-mini S&P 500",
    "NQ=F":  "E-mini NASDAQ 100",
    "YM=F":  "E-mini Dow",
    "RTY=F": "E-mini Russell 2000",
    # Currencies / FX Futures (CME)
    "6E=F":  "Euro FX",
    "6J=F":  "Japanese Yen",
    "6B=F":  "British Pound",
...
COMMODITY_SUMMARIES = {
    "GC": "Precious metal used as a store of value, inflation hedge, and in jewelry.",
    "SI": "Precious and industrial metal used in electronics, solar panels, and jewelry.",
    "PL": "Rare metal used in catalytic converters, jewelry, and hydrogen fuel cells.",
    "PA": "Rare metal primarily used in automotive catalytic converters and electronics.",
    "HG": "Industrial metal essential for electrical wiring, plumbing, and construction.",
    "CL": "Benchmark U.S. crude oil grade; key global energy price reference.",
    "NG": "Fossil fuel used for electricity generation, heating, and industrial processes.",
    "RB": "Reformulated gasoline blendstock; tracks wholesale U.S. gasoline prices.",
    "HO": "Refined petroleum product used for heating and as diesel fuel proxy.",
    "ZC": "Staple grain used for food, animal feed, and ethanol production.",
    "ZS": "Oilseed crop used for animal feed, cooking oil, and biodiesel.",
    "ZW": "Major cereal grain used for bread, pasta, and animal feed globally.",
    "ZL": "Vegetable oil extracted from soybeans; used in food and biodiesel.",
    "ZM": "High-protein animal feed product made from processed soybeans.",
    "ZO": "Cereal grain used in breakfast foods, animal feed, and health products.",
    "ZR": "Staple food grain for billions worldwide, especially in Asia.",
    "LE": "Futures on fed cattle ready for slaughter; tracks beef market prices.",
    "HE": "Futures on market-weight hogs; tracks wholesale pork prices.",
    "GF": "Futures on young cattle placed in feedlots before reaching market weight.",
    "LBS": "Softwood lumber used in residential construction and home building.",
    "DC": "Benchmark dairy futures based on Class III milk used for cheese production.",
    "ES": "Futures on the S&P 500 index; most liquid equity index contract globally.",
    "NQ": "Futures on the NASDAQ-100 index; tracks top tech and growth stocks.",
    "YM": "Futures on the Dow Jones Industrial Average; 30 blue-chip U.S. stocks.",
    "RTY": "Futures on the Russell 2000 small-cap stock index.",
    "6E": "Futures on the EUR/USD exchange rate.",
    "6J": "Futures on the USD/JPY exchange rate (inverse quoted).",
    "6B": "Futures on the GBP/USD exchange rate.",
    "6A": "Futures on the AUD/USD exchange rate.",
    "6C": "Futures on the CAD/USD exchange rate.",
    "ZB": "Futures on 30-year U.S. Treasury bonds; key long-duration interest rate benchmark.",
...
_cl_price, _cl_chg = _fetch_index("CL=F")
_gc_price, _gc_chg = _fetch_index("GC=F")
_es_price, _es_chg = _fetch_index("ES=F")
...
_cards = (
    _banner_card("WTI Crude Oil (CL) — Today", _cl_price, _cl_chg)
    + _banner_card("Gold (GC) — Today", _gc_price, _gc_chg)
    + _banner_card("E-mini S&P 500 (ES) — Today", _es_price, _es_chg)
)
if _cards:
    render_desktop_index_banner(
        st,
        f'<div class="scoop-banner-desktop" style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:1rem;">{_cards}</div>',
        page="pages/5_CME_Top_10.py",
    )
...
if not render_terms_gate(
    ...
    if not all_results:
        ...
        if should_render_desktop_top_picks(page="pages/5_CME_Top_10.py"):
        ...
        render_full_results_heading(st, "CME Top 10")
            ...
            for idx_row, (i, r) in enumerate(dataframe.iterrows()):
                ...
                for c in cols:
                    ...
                    if c == "Commodity":
                        ...
                        cells += _td(
                            c,
                            analyze_link_html(src, from_path="/CME_Top_10"),
                            COLUMN_TIPS.get(c, ""),
                        )
                    else:
                        cells += _td(c, str(val), COLUMN_TIPS.get(c, ""))
