"""
ICE Commodities
Screens major ICE (Intercontinental Exchange) traded commodity futures
for those trading at or near their 52-week low **and** whose recent
headlines do NOT contain signals of severe disruption or regulatory bans.
"""
...
render_responsive_navigation(current_page="pages/6_ICE_Top_10.py")
...
st.markdown(
    ...
    @media (min-width: 1367px) {
        ...
        .full-results-wrap:has(.tip-wrap.headlines-tip .hl-tip-cb:checked),
    ...
    --scoop-tablet-gutter: clamp(0.85rem, 2.5vw, 1.1rem);
        ...
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip) {
            position: relative !important;
            cursor: help !important;
            border-bottom: 1px dashed #888 !important;
        }
        ...
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip) .tip-text {
            visibility: hidden !important;
            opacity: 0 !important;
            position: absolute !important;
            bottom: calc(100% + 12px) !important;
        ...
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip) .tip-text::before {
            content: "" !important;
            display: block !important;
            position: absolute !important;
            bottom: -14px !important;
        ...
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip) .tip-text::after {
            content: "" !important;
            display: block !important;
            position: absolute !important;
            top: 100% !important;
        ...
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip):hover .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip):active .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip):focus-within .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .tip-wrap:not(.headlines-tip) .tip-text:hover,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .full-results-wrap .full-results-table tbody td .fr-label .tip-wrap:not(.headlines-tip):hover .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .full-results-wrap .full-results-table tbody td .fr-label .tip-wrap:not(.headlines-tip):active .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .full-results-wrap .full-results-table tbody td .fr-val .tip-wrap:not(.headlines-tip):hover .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown .full-results-wrap .full-results-table tbody td .fr-val .tip-wrap:not(.headlines-tip):active .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip):hover .tip-text,
        html body .stApp [data-testid="stAppViewContainer"] .stMarkdown [data-testid="stHorizontalBlock"] .tip-wrap:not(.headlines-tip):active .tip-text {
            visibility: visible !important;
            opacity: 1 !important;
        }
        ...
        .stMarkdown .full-results-wrap:has(.tip-wrap:not(.headlines-tip):hover, .tip-wrap:not(.headlines-tip):active, .tip-wrap:not(.headlines-tip):focus-within) {
            overflow: visible !important;
        }
        .stMarkdown .full-results-wrap .full-results-table tbody td:has(.tip-wrap:not(.headlines-tip):hover, .tip-wrap:not(.headlines-tip):active, .tip-wrap:not(.headlines-tip):focus-within) {
            overflow: visible !important;
            position: relative !important;
...
agreed = terms_accepted(st, "agree_terms_ice")
...
COMMODITY_NAMES = {
    ...
    "CC=F":  "Cocoa",
    "KC=F":  "Coffee C (Arabica)",
    "CT=F":  "Cotton No. 2",
    "SB=F":  "Sugar No. 11",
    "OJ=F":  "Orange Juice (FCOJ-A)",
    # Additional ICE-traded
    "DX=F":  "U.S. Dollar Index (DXY)",
    # ICE-listed ETF proxies for commodities without direct Alpha Vantage futures.
    "UNG":   "U.S. Natural Gas Fund (ICE)",
    "USO":   "U.S. Oil Fund (ICE)",
    "WEAT":  "Teucrium Wheat Fund (ICE)",
    "CORN":  "Teucrium Corn Fund (ICE)",
    "SOYB":  "Teucrium Soybean Fund (ICE)",
    "CANE":  "Teucrium Sugar Fund (ICE)",
    "COW":   "iPath Livestock ETN (ICE)",
    "GLD":   "SPDR Gold Shares (ICE)",
    "SLV":   "iShares Silver Trust (ICE)",
    "PALL":  "Aberdeen Palladium ETF (ICE)",
    "PPLT":  "Aberdeen Platinum ETF (ICE)",
    "DBB":   "Invesco Base Metals (ICE)",
    "DBA":   "Invesco Agriculture (ICE)",
    "DBC":   "Invesco Commodity Index (ICE)",
    "PDBC":  "Invesco Optimum Yield (ICE)",
    "GSG":   "iShares S&P GSCI Trust (ICE)",
...
COMMODITY_SUMMARIES = {
    "BZ": "Global benchmark crude oil grade from the North Sea; priced in London.",
    "CC": "Tropical commodity used in chocolate, confections, and beverages.",
    "KC": "Arabica coffee futures; benchmark for high-quality coffee worldwide.",
    "CT": "Natural fiber commodity used in textiles, clothing, and industrial products.",
    "SB": "Raw cane sugar futures; global benchmark for sugar pricing.",
    "OJ": "Frozen concentrated orange juice futures; tracks citrus market prices.",
    "DX": "Index measuring the U.S. dollar against a basket of six major currencies.",
    "UNG": "ETF tracking natural gas prices via near-month futures contracts.",
    "USO": "ETF tracking WTI crude oil prices via near-month futures contracts.",
    "WEAT": "ETF providing exposure to wheat futures prices.",
    "CORN": "ETF providing exposure to corn futures prices.",
    "SOYB": "ETF providing exposure to soybean futures prices.",
    "CANE": "ETF providing exposure to sugar futures prices.",
    "COW": "ETN tracking livestock futures (cattle and hogs).",
    "GLD": "Largest physical gold-backed ETF; tracks the gold spot price.",
    "SLV": "Physical silver-backed ETF; tracks the silver spot price.",
    "PALL": "Physical palladium-backed ETF; tracks the palladium spot price.",
    "PPLT": "Physical platinum-backed ETF; tracks the platinum spot price.",
    "DBB": "ETF tracking a basket of base metals: aluminum, copper, and zinc.",
    "DBA": "ETF tracking a diversified basket of agricultural commodity futures.",
    "DBC": "Broad commodity index ETF tracking 14 commodities across energy, metals, and agriculture.",
    "PDBC": "Actively managed commodity ETF seeking optimum roll yield.",
    "GSG": "ETF tracking the S&P GSCI Total Return Index of commodity futures.",
...
DISQUALIFY_KEYWORDS = [
    "fraud", "illegal", "manipulation", "scandal", "criminal",
    "sanctions", "embargo", "ban", "contamination", "recall",
...
def screen_commodity(ticker: str, snapshot: dict | None = None) -> dict | None:
    ...
    try:
        ...
        return {
            ...
            "Commodity": COMMODITY_NAMES.get(ticker, display_ticker),
            "Price": current_price,
            "52W Low": year_low,
            "52W High": year_high,
...
_bz_price, _bz_chg = _fetch_index("BZ=F")
_dx_price, _dx_chg = _fetch_index("DX=F")
_cc_price, _cc_chg = _fetch_index("CC=F")
...
_cards = (
    _banner_card("Brent Crude Oil (BZ) — Today", _bz_price, _bz_chg)
    + _banner_card("U.S. Dollar Index (DX) — Today", _dx_price, _dx_chg, prefix="")
    + _banner_card("Cocoa (CC) — Today", _cc_price, _cc_chg)
)
if _cards:
    render_desktop_index_banner(
        st,
        f'<div class="scoop-banner-desktop" style="display:flex;gap:1rem;flex-wrap:wrap;margin-bottom:1rem;">{_cards}</div>',
        page="pages/6_ICE_Top_10.py",
    )

# ── UI ────────────────────────────────────────────────────────────────
st.title("🛢️ ICE Commodities")
render_screener_landing_intro(
    st,
    market="ICE",
    universe_size=len(ICE_UNIVERSE),
    asset_label="commodity future or ETF",
...
if not render_terms_gate(
    ...
    if not all_results:
        ...
        st.warning(
            f"No ICE commodities are within **{MAX_PAD_CAP_PCT}%** of their 52-week low right now."
        )
        if st.button("Clear cache and refresh", key="refresh_ice"):
            st.cache_data.clear()
            st.rerun()
        ...
        if not loaded.headlines_enriched:
            df = enrich_headline_sentiment(df, get_market_data(), screener_key="ICE")
        ...
        if should_render_desktop_top_picks(page="pages/6_ICE_Top_10.py"):
            ...
            for idx, col in enumerate(top_cols):
                ...
                with col:
                    ...
                    tip = COMMODITY_SUMMARIES.get(row["Ticker"], "")
                    ...
                    st.markdown(
                        ...
                        f'{row["Commodity"]}<span class="tip-text">{tip}</span></span><br>'
        ...
        render_full_results_heading(st, "ICE Top 10")
        ...
        def _build_html_table(dataframe):
            ...
            for idx_row, (i, r) in enumerate(dataframe.iterrows()):
                ...
                for c in cols:
                    val = r[c]
                    if c == "Commodity":
                        tip = COMMODITY_SUMMARIES.get(r["Ticker"], "")
                        cells += (
                            _td(c, _tip(val, tip, extra_class="scoop-name-tip"), COLUMN_TIPS.get(c, "")) if tip else _td(c, str(val), COLUMN_TIPS.get(c, ""))
                        )
                    elif c == "Headlines":
                        ...
                        cells += _td(
                            c,
                            analyze_link_html(src, from_path="/ICE_Top_10"),
                            COLUMN_TIPS.get(c, ""),
                        )
                    else:
                        cells += _td(c, str(val), COLUMN_TIPS.get(c, ""))
        ...
        st.markdown(
            ...
            > **Disclaimer:** Commodity futures and ETFs involve substantial risk. This is an
            > automated screen — not financial advice. Always do your own due diligence before trading.
            """
        )
